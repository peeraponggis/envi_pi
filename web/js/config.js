...
/**
 * โหมดสาธารณะ: ซ่อนชื่อโรงงานจากข้อมูลเซนเซอร์ POMS (กรมโรงงานฯ) สำหรับผู้ที่ไม่ได้ล็อกอิน
 * แสดงเป็น "โรงงาน <รหัส> · <ประเภท> · <จังหวัด>" แทน · ผู้ล็อกอินเห็นชื่อจริง (ตัดสินใจ 6 ก.ย. 2569 ลดความเสี่ยงการตีความค่าที่อาจเก่า/ผิดพลาดคู่กับชื่อบริษัท)
 * ตั้ง true ถ้าต้องการเปิดชื่อให้สาธารณะ (ข้อมูลต้นทางเปิดเผยชื่ออยู่แล้วที่ poms.diw.go.th)
 */
export const PUBLIC_FACTORY_NAMES = false;
