...
export const EXTRA_PARAM_INFO = {
  ...
  'in:TSS': { name: 'สารแขวนลอยน้ำเข้า (TSS)', unit: 'mg/L', desc: 'ตะกอนในน้ำเข้า ใช้ประเมินภาระตะกอนและหน่วยบำบัดขั้นต้น', std: 'น้ำเสียชุมชนไทยจริง ตารางที่ 2.2 คพ./วสท. 2546 — ท่อระบายรวม 40–110 (แนะนำ 80) · ท่อระบายแยก แนะนำ 160 mg/L', dir: 'none', lines: [{ v: 80, l: 'ท่อรวม 80' }, { v: 160, l: 'ท่อแยก 160' }], bands: [] },
 ...
 * ⭐ เกณฑ์เชิงตัวเลขที่ทำจากข้อมูลน้ำเสียไทยจริง มาจาก เกณฑ์แนะนำการออกแบบระบบรวบรวมน้ำเสียและโรงปรับปรุงคุณภาพน้ำของชุมชน กรมควบคุมมลพิษ ร่วมกับสมาคมวิศวกรรมสิ่งแวดล้อมแห่งประเทศไทย 2546
...
export const PROCESS_TYPES = {
  AS: {
    ...
    monitor: [
      ...
      M('aeration', 'MLSS', { required: true, target: [3000, 6000], note: 'ช่วงของแบบเติมอากาศยืดเวลาตามเกณฑ์ออกแบบไทย 2546 (คู่มือเดินระบบ 2563 ระบุ 2,500–4,000 สำหรับแบบกวนสมบูรณ์)' }),
  ...
  SBR: {
    ...
    monitor: [
      ...
      M('sbr', 'MLSS', { required: true, target: [1500, 3000], note: 'ช่วงตามเกณฑ์ออกแบบไทย 2546 (คู่มือเดินระบบ 2563 ระบุกว้างกว่าที่ 1,500–6,000)' }),
 ...
 * ตารางที่ 7.5 เกณฑ์แนะนำการออกแบบฯ กรมควบคุมมลพิษ ร่วมกับ สมาคมวิศวกรรมสิ่งแวดล้อมแห่งประเทศไทย 2546
 */
...
export const THAI_SEWAGE = {
  ...
  source: 'ตารางที่ 2.2 ลักษณะน้ำเสียชุมชนของประเทศไทย · เกณฑ์แนะนำการออกแบบฯ คพ./วสท. 2546 — เจือจางกว่าค่าอ้างอิงต่างประเทศมาก',
};
...
export function aerationEnergy(code, { q_m3d = 0, bod_in = null, bod_out = 20, sewer = 'combined', aerator = null, field_factor = 0.55, hrt_h = null, mixing_kw_per_1000m3 = null } = {}) {
  ...
  return {
    ...
    estimate: true,
    source: `คิดจากเกณฑ์แนะนำการออกแบบฯ คพ./วสท. 2546 (${p.source} · ตารางที่ 7.5 ประสิทธิภาพเครื่องเติมอากาศ · ตารางที่ 2.2 ลักษณะน้ำเสียไทย) — เป็นเฉพาะไฟของเครื่องเติมอากาศ ยังไม่รวมไฟของสถานีสูบน้ำเสีย ปั๊มสลัดจ์ และระบบสลัดจ์ · ค่าปรับประสิทธิภาพในสนาม ${field_factor} เป็นข้อสมมติของเรา ไม่ได้อยู่ในเกณฑ์`,
    steps: [
