...
export const EXTRA_PARAM_INFO = {
  ...
  'in:BOD': { name: 'บีโอดีน้ำเข้า (BOD)', unit: 'mg/L', desc: 'ภาระสารอินทรีย์ที่เข้าระบบ ใช้คิดภาระเป็นกิโลกรัมต่อวันและประสิทธิภาพกำจัด', std: 'น้ำเสียชุมชนไทยจริงตามเกณฑ์แนะนำการออกแบบ ประกาศ คพ. 2553 ตารางที่ 2.2 — ท่อระบายรวม 65–110 (แนะนำ 80) · ท่อระบายแยก แนะนำ 160 mg/L · เจือจางกว่าค่าอ้างอิงต่างประเทศมาก', dir: 'none', lines: [{ v: 80, l: 'ท่อรวม 80' }, { v: 160, l: 'ท่อแยก 160' }], bands: [] },
  'in:COD': { name: 'ซีโอดีน้ำเข้า (COD)', unit: 'mg/L', desc: 'ภาระสารอินทรีย์รวมที่เข้าระบบ วัดออนไลน์ได้ทันทีจึงใช้แทนบีโอดี', std: 'ประมาณ 2 เท่าของบีโอดี · น้ำเสียชุมชนไทยจึงราว 150–200 (ท่อระบายรวม) ถึง 300–350 (ท่อระบายแยก) · น้ำเสียโรงงานต่างกันมาก', dir: 'none', lines: [], bands: [] },
  'in:TSS': { name: 'สารแขวนลอยน้ำเข้า (TSS)', unit: 'mg/L', desc: 'ตะกอนในน้ำเข้า ใช้ประเมินภาระตะกอนและหน่วยบำบัดขั้นต้น', std: 'น้ำเสียชุมชนไทยจริง ตารางที่ 2.2 ประกาศ คพ. 2553 — ท่อระบายรวม 40–110 (แนะนำ 80) · ท่อระบายแยก แนะนำ 160 mg/L', dir: 'none', lines: [{ v: 80, l: 'ท่อรวม 80' }, { v: 160, l: 'ท่อแยก 160' }], bands: [] },
...
export const STAGES = {
  ...
  pondF2: { name: 'บ่อแฟคัลเททีฟ บ่อที่ 2', icon: '🟡', shape: 'pond' },
  pondM: { name: 'บ่อบ่ม', icon: '🟢', shape: 'pond' },
  pondPolish: { name: 'บ่อขัดแต่ง', icon: '🔷', shape: 'pond' },
  ...
  thicken: { name: 'ถังทำข้นสลัดจ์', icon: '🌀', shape: 'roundTank', kind: 'sludge' },
  cake: { name: 'ถังพักกากตะกอน', icon: '📦', shape: 'tank', kind: 'sludge' },
 ...
 * ⭐ เกณฑ์เชิงตัวเลขที่ทำจากข้อมูลน้ำเสียไทยจริง มาจาก ประกาศกรมควบคุมมลพิษ เรื่อง เกณฑ์การออกแบบระบบรวบรวมน้ำเสียและระบบบำบัดน้ำเสียรวมของชุมชน ประกาศ ณ วันที่ 5 มีนาคม 2553 (ราชกิจจานุเบกษา เล่ม 127 ตอนพิเศษ 72 ง หน้า 27 · 8 มิถุนายน 2553) และคู่มือฉบับเดียวกันที่จัดทำร่วมกับสมาคมวิศวกรรมสิ่งแวดล้อมแห่งประเทศไทย
 *   ซึ่งระบุว่าน้ำเสียชุมชนไทยมีบีโอดีต่ำกว่าค่าอ้างอิงต่างประเทศมาก ระบบในอดีตจึงถูกออกแบบใหญ่เกินจริง
 *   และแนะนำเพียง 3 กระบวนการสำหรับชุมชนไทย: บ่อปรับเสถียร · สระเติมอากาศแบบผสมบางส่วน · เอเอสแบบเติมอากาศยืดเวลา
 *   ⚠️ เกณฑ์เล่มนี้ใช้กับชุมชนระดับเมือง (เทศบาลตำบล เมือง นคร) เท่านั้น ห้ามนำไปใช้กับน้ำเสียอุตสาหกรรม อาคารสูง หรือหมู่บ้าน
...
export const PROCESS_TYPES = {
  AS: {
    ...
    recycles: [
      ...
      R('was', 'clarifier', 'thicken', 'สลัดจ์ส่วนเกิน', 'คุมอายุสลัดจ์ 5–15 วัน', 'อัตราทิ้งสลัดจ์เป็นตัวกำหนดอายุสลัดจ์'),
    ],
    sludge: ['thicken', 'press', 'cake'],
    desc: 'เกณฑ์ออกแบบของไทยแนะนำให้ใช้ **แบบเติมอากาศยืดเวลา** สำหรับน้ำเสียชุมชน · จุลินทรีย์แบบแขวนลอยย่อยสารอินทรีย์ในถังเติมอากาศที่กวนให้ผสมเป็นเนื้อเดียวทั่วทั้งถัง แล้วแยกสลัดจ์ในถังตกตะกอน สูบสลัดจ์ส่วนหนึ่งกลับเพื่อรักษาความเข้มข้นจุลินทรีย์ ที่เหลือเป็นสลัดจ์ส่วนเกินนำไปกำจัด',
    design_note: '⭐ เกณฑ์ออกแบบตามประกาศกรมควบคุมมลพิษ ระบุว่าน้ำเสียชุมชนไทยเจือจาง จึงควรใช้ **เอเอสแบบเติมอากาศยืดเวลา** ไม่ใช่แบบธรรมดา · เกณฑ์ตารางที่ 7.4: อายุสลัดจ์ **20–30 วัน** · อัตราส่วนอาหารต่อจุลชีพ **0.05–0.15** ก.บีโอดี/ก.MLVSS-วัน · MLSS **3,000–6,000** มก./ล. · อัตราสูบสลัดจ์เวียนกลับต่ออัตราน้ำเข้า **0.5–1.0** · ความต้องการออกซิเจน **1.4–1.6** ก.O₂ ต่อ ก.บีโอดีที่ถูกกำจัด · ถังเติมอากาศเก็บกักไม่น้อยกว่า 6 ชม. · เติมอากาศยืดเวลาให้สลัดจ์ที่เสถียรอยู่แล้ว **จึงไม่ต้องมีการบำบัดขั้นต้นและไม่ต้องปรับเสถียรสลัดจ์**\n· เทียบกับคู่มือเดินระบบ คพ. 2563 ตารางที่ 5-5 แบบกวนสมบูรณ์: อัตราส่วนอาหารต่อจุลชีพ 0.2–0.6 กก.บีโอดี/กก.MLSS-วัน · อายุสลัดจ์ 5–15 วัน · ภาระอินทรีย์ 0.8–1.9 กก.บีโอดี/ลบ.ม.-วัน · MLSS 2,500–4,000 มก./ล. · เวลาเก็บกัก 3–5 ชม. · อัตราส่วนสูบสลัดจ์กลับ 0.25–1 · ความต้องการออกซิเจน 0.8–1.1 กก.O₂ ต่อ กก.บีโอดีที่กำจัด · กำจัดบีโอดี 85–95% · โรงชุมชนไทยโดยทั่วไปไม่มีถังตกตะกอนขั้นต้น · ใช้ที่ดินราว 0.3 ตร.ม./คน (กรมโยธาธิการ)',
    monitor: [
      ...
      M('aeration', 'MLSS', { required: true, target: [3000, 6000], note: 'ช่วงของแบบเติมอากาศยืดเวลาตามเกณฑ์ออกแบบตามประกาศ คพ. (คู่มือเดินระบบ 2563 ระบุ 2,500–4,000 สำหรับแบบกวนสมบูรณ์)' }),
  ...
  OD: {
    ...
    recycles: [
      ...
      R('was', 'clarifier', 'thicken', 'สลัดจ์ส่วนเกิน', 'คุมอายุสลัดจ์ 10–30 วัน', 'อายุสลัดจ์ยาวทำให้สลัดจ์เสถียรในถังแล้ว ไม่ต้องมีถังย่อยสลัดจ์แยก'),
    ],
    sludge: ['thicken', 'press', 'cake'],
    ...
    design_note: '⭐ คลองวนเวียนเป็นรูปแบบย่อยของเอเอสแบบเติมอากาศยืดเวลา ตามประกาศกรมควบคุมมลพิษ เรื่องเกณฑ์การออกแบบฯ (ราชกิจจานุเบกษา 8 มิ.ย. 2553) ตารางที่ 7.4: อายุสลัดจ์ 20–30 วัน · อัตราส่วนอาหารต่อจุลชีพ 0.05–0.15 · MLSS 3,000–6,000 มก./ล. · อัตราสูบสลัดจ์เวียนกลับ 0.5–1.0 · ความต้องการออกซิเจน 1.4–1.6 ก.O₂ ต่อ ก.บีโอดีที่ถูกกำจัด · เครื่องกลเติมอากาศแบบหมุนแนวนอนมีประสิทธิภาพมาตรฐาน 1.5–2.1 กก.O₂/kWh\n· เทียบกับคู่มือเดินระบบ คพ. 2563 ตารางที่ 5-5 คลองวนเวียน: อัตราส่วนอาหารต่อจุลชีพ 0.05–0.3 · อายุสลัดจ์ 10–30 วัน · ภาระอินทรีย์ 0.1–0.5 กก.บีโอดี/ลบ.ม.-วัน · MLSS 3,000–6,000 มก./ล. · เวลาเก็บกัก 8–36 ชม. · อัตราส่วนสูบสลัดจ์กลับ 0.75–1.5 · กำจัดบีโอดี 75–95% · เครื่องกลเติมอากาศหมุน 1–3 รอบต่อนาที โซนแอนอกซิกราว 10 นาที · ตัวอย่างโรงจริง โรงปรับปรุงคุณภาพน้ำกาญจนบุรี 24,000 ลบ.ม./วัน บนพื้นที่ 42.5 ไร่ ราว 2.8 ตร.ม. ต่อ ลบ.ม./วัน',
    monitor: [
      IN_FLOW, IN_PH, IN_COD, SCREEN_LV,
  ...
  SBR: {
    ...
    recycles: [R('was', 'sbr', 'thicken', 'สลัดจ์ส่วนเกิน', 'สูบท้ายช่วงตกตะกอน', 'ไม่มีสายสูบสลัดจ์กลับต่อเนื่อง เพราะทำปฏิกิริยาและตกตะกอนในถังเดียวกัน')],
    sludge: ['thicken', 'press'],
    ...
    design_note: '⭐ เกณฑ์ออกแบบตามประกาศกรมควบคุมมลพิษ ตารางที่ 7.4: อายุสลัดจ์ **20–30 วัน** · อัตราส่วนอาหารต่อจุลชีพ 0.05–0.30 · MLSS **1,500–3,000** มก./ล. · ความต้องการออกซิเจน 1.4–1.6 ก.O₂ ต่อ ก.บีโอดีที่ถูกกำจัด · วัฏจักรตัวอย่างในเกณฑ์: ป้อนน้ำเสีย 5–25 นาที → เติมอากาศ 35–50 → แยกน้ำใส 10–20 → ระบายน้ำทิ้ง 10–20 → ทิ้งสลัดจ์ส่วนเกิน 0–5\n· หนึ่งรอบการทำงานมี 5 ช่วงตามคู่มือเดินระบบ คพ. 2563: ช่วงเติมน้ำเสีย → ช่วงทำปฏิกิริยา → ช่วงตกตะกอน → ช่วงระบายน้ำทิ้ง → ช่วงพักระบบ · เกณฑ์ตารางที่ 5-5: อัตราส่วนอาหารต่อจุลชีพ 0.05–0.3 · อายุสลัดจ์ 8–20 วัน · ภาระอินทรีย์ 0.1–0.3 กก.บีโอดี/ลบ.ม.-วัน · MLSS 1,500–6,000 มก./ล. · ความจุถังต่ออัตราไหลเข้า 8–50 ชม. (คู่มือเลี่ยงคำว่าเวลาเก็บกักโดยตั้งใจ) · กำจัดบีโอดี 85–95% · ต้องมีอย่างน้อย 2 ถังสลับรอบเพื่อรับน้ำต่อเนื่อง · ตัวอย่างโรงจริง โครงการยานนาวา กทม. 200,000 ลบ.ม./วัน',
    monitor: [
      IN_FLOW, IN_PH, IN_COD, SCREEN_LV,
      ...
      M('sbr', 'MLSS', { required: true, target: [1500, 3000], note: 'ช่วงตามเกณฑ์ออกแบบตามประกาศ คพ. (คู่มือเดินระบบ 2563 ระบุกว้างกว่าที่ 1,500–6,000)' }),
  ...
  AL: {
    ...
    stages: ['inlet', ...HEAD, 'lagoon', 'pondPolish', 'chlorine', 'outlet'],
    recycles: [R('dredge', 'pondPolish', 'plant', 'ขุดลอกตะกอนก้นบ่อ', 'ตามรอบบำรุงรักษา', 'คู่มือ คพ. ไม่มีหน่วยจัดการตะกอนสำหรับระบบนี้ ใช้การขุดลอกเพื่อคุม MLSS ในบ่อเติมอากาศและบ่อบ่ม')],
    sludge: [],
    ...
    design_note: '⭐ เกณฑ์ออกแบบตามประกาศกรมควบคุมมลพิษ ระบุว่าน้ำเสียชุมชนไทยควรใช้ **สระเติมอากาศแบบผสมบางส่วน** ไม่ใช่แบบผสมสมบูรณ์ เพราะน้ำเสียเจือจางและค่าเดินระบบต่ำกว่า · เกณฑ์ตารางที่ 7.2: สระเติมอากาศ เก็บกัก **1–2 วัน** ลึก 2.0–4.0 ม. (แนะนำ 3.0) กำจัดบีโอดี 80% · ความต้องการออกซิเจน **0.7–1.0 ก.O₂ ต่อ ก.บีโอดีที่ถูกกำจัด** และกำลังเครื่องเติมอากาศ **1.5–3.0 กิโลวัตต์ ต่อ 1,000 ลบ.ม. ของปริมาตรสระ** · บ่อขัดแต่ง เก็บกัก 1–2 วัน ลึก 1.5–2.0 ม.\n· องค์ประกอบตามคู่มือเดินระบบ คพ. 2563: บ่อเติมอากาศ (จำนวนตามการออกแบบ) → บ่อบ่มเพื่อปรับสภาพน้ำทิ้ง → บ่อเติมคลอรีน 1 บ่อ · เกณฑ์ตารางที่ 5-3: บ่อเติมอากาศเก็บกัก 3–10 วัน ลึก 2–6 ม. ความต้องการออกซิเจน 0.7–1.4 กก.O₂ ต่อ กก.บีโอดีที่กำจัด กำลังกวนไม่น้อยกว่า 0.525 กิโลวัตต์ต่อ 100 ลบ.ม. · บ่อบ่มเก็บกักไม่น้อยกว่า 1 วัน · ลดบีโอดี 80–95% · ใช้ที่ดินราว 1 ตร.ม./คน (กรมโยธาธิการ) · ตัวอย่างโรงจริง เทศบาลนครเชียงใหม่ 55,000 ลบ.ม./วัน บนพื้นที่ 100 ไร่',
    monitor: [
      IN_FLOW, IN_PH, IN_COD, SCREEN_LV,
      ...
      M('pondPolish', 'DO'),
      M('pondPolish', 'SBlanket', { required: true, note: 'ความหนาตะกอนสะสมก้นบ่อ ใช้วางแผนขุดลอก' }),
      CL2('chlorine'),
      ...OUT_COMMUNITY,
    ],
  ...
  SP: {
    ...
    stages: ['inlet', ...HEAD, 'pondA', 'pondF', 'pondF2', 'pondM', 'outlet'],
    optional: ['pondA', 'pondM'],
    recycles: [R('dredge', 'pondF', 'plant', 'ขุดลอกตะกอนก้นบ่อ', 'ทุก 2–5 ปี', 'สลัดจ์ย่อยสลายแบบไร้อากาศที่ก้นบ่อเอง คู่มือ คพ. ไม่มีหน่วยจัดการตะกอนสำหรับระบบนี้')],
    sludge: [],
    ...
    design_note: '⭐ เกณฑ์ออกแบบตามประกาศกรมควบคุมมลพิษ แนะนำให้ใช้ **บ่อแฟคัลเททีฟต่อกันแบบอนุกรมอย่างน้อย 2 บ่อ** ก็เพียงพอจะผ่านมาตรฐานน้ำทิ้ง และเพิ่มบ่อบ่มอีก 1 บ่อเมื่อต้องการลดของแข็งแขวนลอยและเชื้อโรค · **ไม่แนะนำบ่อแอนแอโรบิกสำหรับน้ำเสียชุมชน** เพราะเหมาะกับน้ำเสียที่เข้มข้นสูงกว่า และเป็นแหล่งกลิ่น · เกณฑ์ตารางที่ 7.1: อัตราภาระบีโอดีเชิงพื้นที่ 20–25 ก./ตร.ม.-วัน ที่ 25 °C (15–20 ที่ 20 °C · 10–15 ที่ 15 °C ให้เลือกที่อุณหภูมิต่ำสุดในรอบปี) · ความลึกน้ำไม่น้อยกว่า 1.5 ม. · กำจัดบีโอดี 65–75% · บ่อบ่มลึก 1.0–1.5 ม. เก็บกัก 1–2 วัน · ความยาวบ่อไม่น้อยกว่า 2 เท่าของความกว้างเพื่อกันการไหลลัดวงจร · ขอบบ่อเหนือน้ำ 0.5–1.0 ม. (แนะนำ 0.6) · ท่อน้ำออกต้องอยู่ต่ำกว่าผิวน้ำเพื่อลดสาหร่ายที่หลุดออกไป\n· เทียบกับคู่มือเดินระบบ คพ. 2563 ซึ่งระบุชุด 4 บ่อ (แอนแอโรบิค แฟคัลเททีฟ แอโรบิค บ่อบ่ม) อย่างน้อย 3 บ่ออนุกรม และไม่จำเป็นต้องมีระบบฆ่าเชื้อโรค · เกณฑ์ตารางที่ 5-1: บ่อแอนแอโรบิค เก็บกัก 4.5 วัน ลึก 2–4 ม. กำจัดบีโอดี 50% · บ่อแฟคัลเททีฟ 7–30 วัน ลึก 1–1.5 ม. ภาระ 34 ก.บีโอดี/ตร.ม.-วัน กำจัด 70–90% · บ่อแอโรบิค 4–6 วัน ลึก 0.2–0.6 ม. ภาระ 45 ก./ตร.ม.-วัน กำจัด 80–95% · บ่อบ่ม 5–20 วัน ลึก 1–1.5 ม. ภาระ 2 ก./ตร.ม.-วัน กำจัด 60–80% · ใช้ที่ดินมากที่สุดราว 3 ตร.ม./คน (กรมโยธาธิการ) · ตัวอย่างโรงจริง เทศบาลนครหาดใหญ่ 138,000 ลบ.ม./วัน · ได้เกณฑ์น้ำทิ้งผ่อนปรน (ของแข็งแขวนลอย 50 และบีโอดีของน้ำกรอง) เฉพาะเมื่อเก็บกักไม่น้อยกว่า 7 วันโดยคิดปริมาตรที่ความลึกไม่เกิน 2 เมตร',
    monitor: [
      ...
      M('pondF2', 'DO', { note: 'บ่อแฟคัลเททีฟบ่อที่สอง ค่าออกซิเจนควรสูงกว่าบ่อแรกเพราะภาระลดลงแล้ว' }),
  ...
  MBR: {
    ...
    recycles: [
      ...
      R('was', 'membrane', 'thicken', 'สลัดจ์ส่วนเกิน', 'คุมอายุสลัดจ์ 15–30 วัน', ''),
    ],
    sludge: ['thicken', 'press'],
  ...
  UASB: {
    ...
    recycles: [
      ...
      R('was', 'uasb', 'thicken', 'สลัดจ์ส่วนเกิน', 'สูบเมื่อชั้นสลัดจ์สูงเกินค่าออกแบบ', 'สลัดจ์เม็ดมีค่า ควรเก็บไว้ใช้เริ่มระบบอื่น'),
    ],
    sludge: ['thicken', 'press'],
  ...
  Anaerobic: {
    ...
    recycles: [
      ...
      R('was', 'anaerobic', 'thicken', 'สลัดจ์ส่วนเกิน', 'สูบปีละ 1–2 ครั้ง', ''),
    ],
    sludge: ['thicken', 'dryBed'],
  ...
  IND: {
    ...
    recycles: [
      ...
      R('was', 'clarifier', 'thicken', 'สลัดจ์ส่วนเกิน', 'ตามภาระสารอินทรีย์', 'สลัดจ์จากขั้นตอนเคมีมักเป็นของเสียอันตราย ต้องส่งกำจัดตามกฎหมาย'),
    ],
    sludge: ['thicken', 'press', 'cake'],
...
// ─────────────────────────────────────────────────────────── พลังงานเติมอากาศจากเกณฑ์ออกแบบไทย
/**
 * ประสิทธิภาพการเติมอากาศมาตรฐาน (SAE) กิโลกรัมออกซิเจนต่อกิโลวัตต์-ชั่วโมง
 * ตารางที่ 7.5 ท้ายประกาศกรมควบคุมมลพิษ เรื่องเกณฑ์การออกแบบระบบรวบรวมน้ำเสียและระบบบำบัดน้ำเสียรวมของชุมชน (ราชกิจจานุเบกษา เล่ม 127 ตอนพิเศษ 72 ง · 8 มิ.ย. 2553)
 */
export const AERATOR_SAE = {
  porous: { name: 'หัวฟูชนิดรูพรุน', sae: [1.9, 6.6] },
  nonporous: { name: 'หัวฟูชนิดไม่ใช่รูพรุน', sae: [1.3, 1.9] },
  jet: { name: 'เครื่องเติมอากาศแบบดูดพ่น', sae: [2.2, 3.5] },
  surface_radial: { name: 'ผิวน้ำ แบบหมุนช้าไหลตามรัศมี (20–100 รอบ/นาที)', sae: [1.5, 2.1] },
  surface_axial: { name: 'ผิวน้ำ แบบหมุนเร็วไหลตามแกน (900–1,800 รอบ/นาที)', sae: [1.1, 1.4] },
  horizontal: { name: 'แบบหมุนแนวนอน (ใช้กับคลองวนเวียน)', sae: [1.5, 2.1] },
  aspirating: { name: 'แบบดูด', sae: [0.5, 0.8] },
  turbine: { name: 'กังหันจมน้ำ', sae: [1.1, 2.1] },
};
/** ค่าออกแบบของไทยรายประเภทระบบ — ความต้องการออกซิเจน กำลังกวน และชนิดเครื่องเติมอากาศที่ใช้กันจริง */
export const PCD_AERATION = {
...
/** ค่าเริ่มต้นลักษณะน้ำเสียชุมชนไทย ตารางที่ 2.2 */
export const THAI_SEWAGE = {
  combined: { name: 'ท่อระบายรวม', bod: 80, bod_range: [65, 110], tss: 80, tss_range: [40, 110], tkn: 30, tp: 4 },
  separate: { name: 'ท่อระบายแยก', bod: 160, tss: 160, tkn: 30, tp: 4 },
  source: 'ตารางที่ 2.2 ลักษณะน้ำเสียชุมชนของประเทศไทย · ประกาศกรมควบคุมมลพิษ เรื่องเกณฑ์การออกแบบฯ (ราชกิจจานุเบกษา 8 มิ.ย. 2553) — เจือจางกว่าค่าอ้างอิงต่างประเทศมาก',
};

/**
 * หน่วยไฟของเครื่องเติมอากาศ คิดจากเกณฑ์ออกแบบของไทยแทนการใช้ตัวเลข kWh/m³ จากวรรณกรรมต่างประเทศ
 * คิดสองทางแล้วเลือกทางที่มากกว่า ตามที่เกณฑ์ระบุว่า "ถ้าปัจจัยใดต้องการปริมาณการเติมอากาศมากกว่ากัน
 * จะเป็นตัวควบคุมในการออกแบบขนาดของเครื่องเติมอากาศนั้น"
 *   ทางที่ 1 ความต้องการออกซิเจน: บีโอดีที่ถูกกำจัด × ก.O₂ ต่อ ก.บีโอดี ÷ ประสิทธิภาพเติมอากาศในสนาม
...
export function aerationEnergy(code, { q_m3d = 0, bod_in = null, bod_out = null, sewer = 'combined', aerator = null, field_factor = 0.5, hrt_h = null, mixing_kw_per_1000m3 = null, o2_mode = 'design' } = {}) {
  ...
  return {
    ...
    steps: [
      ...
      ...(kwh_mix != null ? [
        STEP('ปริมาตรถังหรือสระ', `ปริมาณน้ำ × เวลาเก็บกัก ÷ 24 = ${n$(q_m3d)} × ${n$(hrt, 1)} ÷ 24`, volume, 'm³', 'benchmark'),
        STEP('ทางที่ 2 หน่วยไฟตามการผสม', `ปริมาตร ÷ 1,000 × ${mixKw} กิโลวัตต์ × 24 ชม. = ${n$(volume)} ÷ 1,000 × ${mixKw} × 24`, kwh_mix, 'kWh/วัน', 'benchmark'),
      ] : []),
      STEP('เลือกทางที่มากกว่า', governing === 'mixing' ? 'การผสมเป็นตัวควบคุมการออกแบบ' : 'ความต้องการออกซิเจนเป็นตัวควบคุมการออกแบบ', kwh_day, 'kWh/วัน', 'benchmark'),
      STEP('หน่วยไฟต่อลูกบาศก์เมตร', `${n$(kwh_day)} ÷ ${n$(q_m3d)}`, kwh_m3, 'kWh/m³', 'benchmark'),
    ],
  };
}

// ─────────────────────────────────────────────────────────── วิธีได้มาของค่าแต่ละพารามิเตอร์
/**
 * บางพารามิเตอร์วัดต่อเนื่องแบบเรียลไทม์ไม่ได้จริง ต้องเก็บตัวอย่างส่งห้องปฏิบัติการก่อนแล้วจึงกรอกผลเข้าระบบ
 * ประกาศมาตรฐานควบคุมการระบายน้ำทิ้งจากระบบบำบัดน้ำเสียรวมของชุมชน ข้อ 3 กำหนดให้ตรวจสอบตาม
 * Standard Methods for the Examination of Water and Wastewater ฉบับล่าสุด ซึ่งบีโอดีต้องบ่ม 5 วัน
 * ค่าที่ใช้ตัดสินว่าผ่านมาตรฐานหรือไม่จึงเป็นผลแล็บเสมอ ส่วนเซนเซอร์ออนไลน์ใช้เฝ้าระวังและเดินระบบ
 */
export const MEASURE_MODES = {
  online: { key: 'online', name: 'วัดต่อเนื่องออนไลน์', short: 'ออนไลน์', desc: 'หัววัดจุ่มในน้ำหรือติดกับท่อ อ่านค่าได้ตลอดเวลา ใช้ควบคุมการเดินระบบและแจ้งเตือนได้ทันที' },
  surrogate: { key: 'surrogate', name: 'ออนไลน์แบบค่าสหสัมพันธ์', short: 'ออนไลน์ (ค่าสหสัมพันธ์)', desc: 'เครื่องวัดคุณสมบัติทางแสงแล้วแปลงเป็นค่าที่ต้องการ ต้องสร้างสมการสหสัมพันธ์กับผลแล็บของโรงตัวเองและสอบเทียบซ้ำเป็นประจำ ใช้เฝ้าระวังได้ แต่ไม่ใช่ค่าที่ใช้ตัดสินตามมาตรฐาน' },
  analyzer: { key: 'analyzer', name: 'เครื่องวิเคราะห์ออนไลน์', short: 'วิเคราะห์เป็นรอบ', desc: 'เครื่องดูดตัวอย่างมาทำปฏิกิริยากับรีเอเจนต์แล้ววัด ได้ค่าเป็นรอบทุก 10 นาทีถึง 2 ชั่วโมง ไม่ใช่ค่าต่อเนื่อง มีค่ารีเอเจนต์และของเสียเคมีที่ต้องกำจัด' },
  lab: { key: 'lab', name: 'ผลวิเคราะห์จากห้องปฏิบัติการ', short: 'ผลแล็บ กรอกเอง', desc: 'ต้องเก็บตัวอย่างส่งห้องปฏิบัติการตามวิธีมาตรฐาน แล้วนำผลมากรอกเข้าระบบ ไม่มีเซนเซอร์ที่ให้ค่านี้แบบต่อเนื่องได้' },
};
/** พารามิเตอร์ → วิธีได้มา · ค่าเริ่มต้นคือ online */
const MEASURE_OF = {
  // ต้องส่งห้องปฏิบัติการ
  'eff:BOD': 'lab', 'in:BOD': 'lab', BOD: 'lab', 'eff:FOG': 'lab',
  // เครื่องวิเคราะห์ออนไลน์ที่ใช้รีเอเจนต์ ได้ค่าเป็นรอบ
  'eff:TN': 'analyzer', 'eff:TP': 'analyzer',
  // ออนไลน์แบบค่าสหสัมพันธ์ ต้องสอบเทียบกับแล็บ
  'eff:COD': 'surrogate', 'in:COD': 'surrogate', COD: 'surrogate',
  'eff:TSS': 'surrogate', 'in:TSS': 'surrogate', MLSS: 'surrogate', NH4N: 'surrogate', NO3N: 'surrogate',
};
/** หมายเหตุเฉพาะรายพารามิเตอร์ ต่อท้ายคำอธิบายของวิธีได้มา */
const MEASURE_NOTE = {
  'eff:BOD': 'บีโอดีตามวิธีมาตรฐานต้องบ่มตัวอย่าง 5 วัน จึงไม่มีทางได้ค่าแบบเรียลไทม์ · เครื่องวัดบีโอดีออนไลน์ให้ค่าเทียบเคียงจากยูวี-วิสิเบิลหรือการหายใจของจุลินทรีย์ ใช้เฝ้าระวังได้แต่ค่าที่ใช้ตัดสินตามมาตรฐานต้องเป็นผลแล็บ',
  'in:BOD': 'เช่นเดียวกับบีโอดีน้ำทิ้ง ต้องบ่ม 5 วัน · ใช้ซีโอดีน้ำเข้าแบบออนไลน์เป็นตัวแทนในการเดินระบบ',
  'eff:FOG': 'วิธีมาตรฐานต้องสกัดด้วยตัวทำละลายในห้องปฏิบัติการ · เครื่องออนไลน์มีแต่ราคาสูงและใช้เฉพาะที่มีความเสี่ยงไขมันรั่วประจำ',
  'eff:TN': 'ต้องย่อยตัวอย่างด้วยความร้อนก่อนวัด รอบการวัดราว 30 นาทีถึง 2 ชั่วโมง · โรงขนาดเล็กมักใช้แอมโมเนียมกับไนเตรตประกอบแล้วส่งแล็บยืนยันเป็นงวด',
  'eff:TP': 'ต้องย่อยตัวอย่างด้วยกรดและความร้อนก่อนวัดสี รอบการวัดราว 30 นาทีถึง 2 ชั่วโมง',
  'eff:COD': 'ยูวี-วิสิเบิลวัดการดูดกลืนแสงแล้วแปลงเป็นซีโอดี ต้องสร้างสมการกับผลแล็บของโรงตัวเอง · เครื่องแบบใช้ไดโครเมตให้ค่าตรงวิธีมาตรฐานแต่ใช้สารเคมีและมีของเสียอันตราย',
  'eff:TSS': 'วัดจากการกระเจิงแสงแล้วแปลงเป็นมิลลิกรัมต่อลิตร ต้องสอบเทียบกับผลแล็บของโรงตัวเอง เพราะขนาดและสีของตะกอนต่างกันทำให้ความสัมพันธ์ต่างกัน',
  MLSS: 'วัดจากการกระเจิงแสงเช่นกัน ใช้เดินระบบได้ดี แต่ต้องเทียบกับการชั่งน้ำหนักแห้งของแล็บเดือนละครั้ง',
  NH4N: 'อิเล็กโทรดเลือกจำเพาะไอออนราคาถูกแต่ต้องสอบเทียบทุก 2 สัปดาห์ · แบบเครื่องวิเคราะห์วัดสีแม่นกว่าแต่ใช้รีเอเจนต์',
};
/** วิธีได้มาของค่าพารามิเตอร์หนึ่ง */
export function measureOf(param) {
  const key = MEASURE_OF[param] ?? 'online';
  const m = MEASURE_MODES[key];
  return { ...m, note: MEASURE_NOTE[param] ?? null, lab_required: key === 'lab' };
}
/** ข้อความสั้นต่อท้ายชื่อพารามิเตอร์ในรายการเลือกและตาราง */
export const measureTag = (param) => {
  const m = measureOf(param);
  return m.key === 'online' ? '' : ` · ${m.short}`;
};

// ─────────────────────────────────────────────────────────── บรรณานุกรมและเครื่องมือที่ใช้พัฒนา
/**
 * แหล่งที่มาของข้อมูลทุกชุดที่โปรแกรมใช้ และเครื่องมือที่ใช้พัฒนา
 * จัดรูปแบบตามบรรณานุกรม: ผู้แต่ง. (ปี). ชื่อเรื่อง. แหล่งที่มา.
 * kind: law = กฎหมายและประกาศ · doc = เอกสารวิชาการและคู่มือ · data = ชุดข้อมูลที่ดึงมาใช้จริง · tool = เครื่องมือพัฒนา
 */
export const REFERENCES = [
  // ── กฎหมายและประกาศ ──
  { kind: 'law', author: 'กระทรวงทรัพยากรธรรมชาติและสิ่งแวดล้อม', year: '2553',
    title: 'ประกาศกระทรวงทรัพยากรธรรมชาติและสิ่งแวดล้อม เรื่อง กำหนดมาตรฐานควบคุมการระบายน้ำทิ้งจากระบบบำบัดน้ำเสียรวมของชุมชน',
    src: 'ราชกิจจานุเบกษา เล่ม 127 ตอนพิเศษ 69 ง หน้า 27–28 (2 มิถุนายน 2553)', url: 'https://www.pcd.go.th/laws/4508',
    use: 'เกณฑ์ตัดสินคุณภาพน้ำทิ้ง 6 พารามิเตอร์ ใช้ในการแปลผลทุกหน้าและกำหนดจุดวัดบังคับที่น้ำทิ้ง' },
  { kind: 'law', author: 'กรมควบคุมมลพิษ', year: '2553',
    title: 'ประกาศกรมควบคุมมลพิษ เรื่อง เกณฑ์การออกแบบระบบรวบรวมน้ำเสียและระบบบำบัดน้ำเสียรวมของชุมชน',
    src: 'ราชกิจจานุเบกษา เล่ม 127 ตอนพิเศษ 72 ง หน้า 27 (8 มิถุนายน 2553)', url: 'https://www.pcd.go.th/laws/4932',
    use: 'ลักษณะน้ำเสียชุมชนไทย เกณฑ์ออกแบบรายประเภทระบบ ประสิทธิภาพเครื่องเติมอากาศ และการคิดหน่วยไฟของเครื่องเติมอากาศ' },
  { kind: 'law', author: 'กรมโรงงานอุตสาหกรรม', year: '—',
    title: 'ข้อกำหนดการติดตั้งเครื่องมือวัดมลพิษน้ำแบบต่อเนื่องและการรายงานผ่านระบบ POMS/WPMS',
    src: 'ประกาศกรมโรงงานอุตสาหกรรม', url: null,
    use: 'เงื่อนไขที่โรงงานต้องติดเครื่องวัดออนไลน์ และรายการพารามิเตอร์ที่ต้องส่งเข้าระบบ' },
  // ── เอกสารวิชาการและคู่มือ ──
  { kind: 'doc', author: 'กรมควบคุมมลพิษ และ สมาคมวิศวกรรมสิ่งแวดล้อมแห่งประเทศไทย', year: '2546',
    title: 'เกณฑ์แนะนำการออกแบบระบบรวบรวมน้ำเสียและโรงปรับปรุงคุณภาพน้ำของชุมชน เล่ม 1 สรุปเกณฑ์แนะนำการออกแบบ',
    src: 'กรุงเทพฯ: สมาคมวิศวกรรมสิ่งแวดล้อมแห่งประเทศไทย, 150 หน้า', url: 'https://www.pcd.go.th/publication/6380',
    use: 'เนื้อหาชุดเดียวกับประกาศกรมควบคุมมลพิษข้างต้น ใช้เป็นฉบับอ่านประกอบ' },
  { kind: 'doc', author: 'กรมควบคุมมลพิษ และ สมาคมวิศวกรรมสิ่งแวดล้อมแห่งประเทศไทย', year: '2546',
    title: 'เกณฑ์แนะนำการออกแบบฯ เล่ม 2 รายละเอียดสนับสนุนเกณฑ์แนะนำการออกแบบ',
    src: 'คลังเอกสารห้องสมุด มหาวิทยาลัยเทคโนโลยีสุรนารี', url: 'http://sutlib2.sut.ac.th/sut_contents/H92223.2.pdf',
    use: 'รายละเอียดขยายความของแต่ละหน่วยบำบัด' },
  { kind: 'doc', author: 'กรมควบคุมมลพิษ และ สมาคมวิศวกรรมสิ่งแวดล้อมแห่งประเทศไทย', year: '2546',
    title: 'เกณฑ์แนะนำการออกแบบฯ เล่ม 3 ตัวอย่างการคำนวณ',
    src: 'คลังเอกสารห้องสมุด มหาวิทยาลัยเทคโนโลยีสุรนารี', url: 'http://sutlib2.sut.ac.th/sut_contents/H92223.3.pdf',
    use: 'ตัวอย่างคำนวณสระเติมอากาศ ใช้ทวนความถูกต้องของการคิดหน่วยไฟเครื่องเติมอากาศในโปรแกรม' },
  { kind: 'doc', author: 'กรมควบคุมมลพิษ, สำนักจัดการคุณภาพน้ำ', year: '2563',
    title: 'คู่มือระบบบำบัดน้ำเสียชุมชน', src: 'กรมควบคุมมลพิษ (19 พฤษภาคม 2563)', url: 'https://www.pcd.go.th/publication/4241',
    use: 'ลำดับหน่วยบำบัด การจำแนกประเภทระบบ 5 ประเภท สำมะโนโรงบำบัด และแนวทางเดินระบบ' },
  { kind: 'doc', author: 'Metcalf & Eddy, Inc.', year: '2014',
    title: 'Wastewater Engineering: Treatment and Resource Recovery (5th ed.)', src: 'New York: McGraw-Hill', url: null,
    use: 'หลักการทั่วไปของกระบวนการบำบัด และช่วงอ้างอิงหน่วยไฟต่อลูกบาศก์เมตรที่ใช้เทียบ (ไม่ใช่ตัวเลขไทย)' },
  { kind: 'doc', author: 'U.S. Environmental Protection Agency', year: '2000',
    title: 'Constructed Wetlands Treatment of Municipal Wastewater (EPA/625/R-99/010)', src: 'Cincinnati, OH: US EPA', url: null,
    use: 'เกณฑ์ออกแบบบึงประดิษฐ์ ซึ่งคู่มือของ คพ. อ้างอิงต่อมาโดยตรง' },
  // ── ชุดข้อมูลที่ดึงมาใช้จริง ──
  { kind: 'data', author: 'กรมควบคุมมลพิษ ร่วมกับ GIZ', year: '2569',
    title: 'DSPOT ฐานข้อมูลระบบบำบัดน้ำเสียรวมชุมชน (Database System for Publicly Owned Treatment Works)',
    src: 'ทะเบียนระบบบำบัดชุมชน 216 แห่ง พร้อมประเภทระบบ ความสามารถ น้ำเข้าจริง พิกัด และผลวิเคราะห์', url: 'https://dspot.pcd.go.th/database',
    use: 'รายชื่อโรงจริงในขั้นตอนที่ 1 และค่าตั้งต้นของการออกแบบ' },
  { kind: 'data', author: 'กรมโรงงานอุตสาหกรรม', year: '2569',
    title: 'ระบบเฝ้าระวังและเตือนภัยมลพิษระยะไกล POMS/WPMS', src: 'ข้อมูลเซนเซอร์น้ำทิ้งโรงงาน 796 แห่ง อ่านทุก 15 นาที', url: 'https://poms.diw.go.th',
    use: 'ค่าน้ำทิ้งและกำลังไฟฟ้าที่วัดจริง ใช้เทียบหน่วยไฟต่อลูกบาศก์เมตรของระบบอุตสาหกรรม' },
  { kind: 'data', author: 'กรมควบคุมมลพิษ', year: '2569',
    title: 'IWIS ระบบตรวจวัดคุณภาพน้ำอัตโนมัติในแหล่งน้ำผิวดิน', src: 'สถานีตรวจวัดอัตโนมัติ 64 สถานี อ่านรายชั่วโมง', url: 'https://api-iwis.pcd.go.th',
    use: 'คุณภาพแหล่งน้ำรับน้ำทิ้ง ใช้ในแดชบอร์ดคุณภาพน้ำเรียลไทม์' },
  { kind: 'data', author: 'กรมพัฒนาพลังงานทดแทนและอนุรักษ์พลังงาน', year: '2560',
    title: 'แผนที่ศักยภาพพลังงานแสงอาทิตย์รายตำบล', src: 'ค่าความเข้มรังสีรวมรายเดือน 7,416 ตำบล หน่วยเมกะจูลต่อตารางเมตรต่อวัน', url: 'https://pei.dede.go.th/dataset/sed01',
    use: 'ชั่วโมงแดดเต็มที่ของตำแหน่งโรง ใช้คิดขนาดระบบโซลาร์' },
  { kind: 'data', author: 'National Aeronautics and Space Administration', year: '2026',
    title: 'POWER Data Access Viewer', src: 'ข้อมูลรังสีอาทิตย์และภูมิอากาศจากดาวเทียม', url: 'https://power.larc.nasa.gov',
    use: 'ชั่วโมงแดดเต็มที่สำรอง เมื่อไม่มีสถานีของ พพ. ในรัศมี 15 กิโลเมตร' },
  { kind: 'data', author: 'Esri และ Google', year: '2569',
    title: 'บริการแผนที่ฐานภาพถ่ายดาวเทียม World Imagery และ Google Maps tiles', src: 'ใช้แสดงที่ตั้งโรงจริง', url: null,
    use: 'กรอบแผนที่ภาพถ่ายดาวเทียมในการ์ดสรุป' },
  // ── เครื่องมือที่ใช้พัฒนา ──
  { kind: 'tool', author: 'Supabase', year: '2569', title: 'Supabase (PostgreSQL, PostGIS, Edge Functions, Row Level Security)',
    src: 'ฐานข้อมูลและบริการหลังบ้าน', url: 'https://supabase.com', use: 'เก็บทะเบียนสถานี ค่าตรวจวัด และแบบที่ผู้ใช้บันทึก' },
  { kind: 'tool', author: 'Chart.js contributors', year: '2569', title: 'Chart.js 4.4.1', src: 'ไลบรารีกราฟ', url: 'https://www.chartjs.org', use: 'กราฟพลังงาน การเงิน และอนุกรมเวลาจำลอง' },
  { kind: 'tool', author: 'Vladimir Agafonkin และคณะ', year: '2569', title: 'Leaflet 1.9.4', src: 'ไลบรารีแผนที่', url: 'https://leafletjs.com', use: 'กรอบแผนที่ภาพถ่ายดาวเทียมและแผนที่ระบบบำบัด' },
  { kind: 'tool', author: 'SheetJS', year: '2569', title: 'SheetJS Community Edition 0.18.5', src: 'ไลบรารีอ่านเขียนไฟล์ตาราง', url: 'https://sheetjs.com', use: 'ส่งออกผลการออกแบบเป็นไฟล์ XLSX' },
  { kind: 'tool', author: 'Google Fonts', year: '2569', title: 'ฟอนต์ Sarabun', src: 'ฟอนต์ภาษาไทย', url: 'https://fonts.google.com/specimen/Sarabun', use: 'ตัวอักษรทั้งระบบ' },
  { kind: 'tool', author: 'OpenJS Foundation', year: '2569', title: 'Node.js test runner', src: 'เครื่องมือทดสอบในตัวของ Node.js', url: 'https://nodejs.org/api/test.html', use: 'ชุดทดสอบสูตรคำนวณและผังกระบวนการ' },
  { kind: 'tool', author: 'GitHub', year: '2569', title: 'GitHub Pages', src: 'บริการเผยแพร่หน้าเว็บแบบสถิต', url: 'https://pages.github.com', use: 'เผยแพร่โปรแกรมนี้' },
];
/** จัดกลุ่มบรรณานุกรมตามชนิด เรียงตามชื่อผู้แต่ง */
export const REFERENCE_GROUPS = [
  { kind: 'law', name: 'กฎหมาย ประกาศ และมาตรฐาน' },
  { kind: 'doc', name: 'เอกสารวิชาการและคู่มือ' },
  { kind: 'data', name: 'ชุดข้อมูลที่โปรแกรมดึงมาใช้' },
  { kind: 'tool', name: 'เครื่องมือที่ใช้พัฒนาโปรแกรม' },
];
/** ข้อความบรรณานุกรมหนึ่งรายการ: ผู้แต่ง. (ปี). ชื่อเรื่อง. แหล่งที่มา. */
export const citationOf = (r) => `${r.author}. (${r.year}). ${r.title}. ${r.src}.`;
