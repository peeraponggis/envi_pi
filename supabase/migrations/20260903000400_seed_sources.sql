...
('dwr_basins', 'water', 'กรมทรัพยากรน้ำ', 'ลุ่มน้ำ / ชั้นคุณภาพลุ่มน้ำ / อุทยาน (SHP)',
 'https://webgis.dwr.go.th/downloads', 'static_file', 'ไม่ระบุ', null, null, '2026-09-03', 'นำเข้าเป็น layers', '{}'),
