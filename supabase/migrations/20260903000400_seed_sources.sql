...
('gistda_flood', 'disaster', 'GISTDA', 'พื้นที่น้ำท่วมจากดาวเทียมรายวัน (STAC flood1day_r2)',
 'https://api-gateway.gistda.or.th/api/2.0/resources/stac/flood/collections/flood1day_r2/items', 'key_json', 'ไม่ระบุ', 360, 'gistda_flood', '2026-09-03',
 'ใช้งานแล้ว 3 ก.ย. 69 (Secret GISTDA_API_KEY) · item เดียว assets.data = GeoJSON ทั้งประเทศ → แทนที่ layer gistda_flood_1d ทุก 6 ชม. · flood3/7/30day ไม่มี item · gi-service flood-recurrence 404', '{"layer_id":"gistda_flood_1d"}'),
('gistda_burnscar', 'disaster', 'GISTDA', 'รอยไหม้จากภาพดาวเทียม 79,435 โพลิกอน (features/burn-scar)',
 'https://api-gateway.gistda.or.th/api/2.0/resources/features/burn-scar', 'key_json', 'ไม่ระบุ', null, 'burnscar', '2026-09-03',
 'เรียกตามจุด (bbox ±5 กม.) ผ่าน Edge action "burnscar" แคช 24 ชม. · props: date "YYYYMMDD - YYYYMMDD", area_rai, lu_name, pv_tn, ap_tn, tb_tn', '{}'),
